  ...
  return (
    <div>
      ...
      >
        ...
        {gitCodeUrl && 
            (<Link href={gitCodeUrl} target="_blank" className="h-14 w-14 relative rounded-full border-2 border-[#ADB7BE] mx-4 hover:border-white group/link">
          ...
          {previewUrl  && 
          ( <Link href={previewUrl} target="_blank" className="h-14 w-14 relative rounded-full border-2 border-[#ADB7BE] mx-4 hover:border-white group/link">
